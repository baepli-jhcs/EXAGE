...
".cpp") then comment out << extern "C" >> bellow in this header file)
  _________
...
/******************************************************************************************************/
#    ifdef _WIN32
/* On windows, if you want to use UTF-8 ( instead of the UTF-16/wchar_t functions at the end of this
file ) Make sure your code is really prepared for UTF-8 (on windows, functions like fopen() expect
MBCS and not UTF-8) */
...
extern int
    tinyfd_silent; /* 1 (default) or 0 : on unix, hide errors and warnings from called dialogs */
...
int tinyfd_messageBox(char const* aTitle, /* NULL or "" */
                      char const* aMessage, /* NULL or "" may contain \n \t */
...
char* tinyfd_inputBox(char const* aTitle, /* NULL or "" */
...
int tinyfd_notifyPopupW(wchar_t const* aTitle, /* NULL or L"" */
                        wchar_t const* aMessage, /* NULL or L"" may contain \n \t */
                        wchar_t const* aIconType); /* L"info" L"warning" L"error" */

/* windows only - utf-16 version */
int tinyfd_messageBoxW(wchar_t const* aTitle, /* NULL or L"" */
                       wchar_t const* aMessage, /* NULL or L"" may contain \n \t */
...
/* windows only - utf-16 version */
wchar_t* tinyfd_inputBoxW(wchar_t const* aTitle, /* NULL or L"" */
...
wchar_t* tinyfd_saveFileDialogW(
    ...
    int aNumOfFilterPatterns, /* 0 (1 in the following example) */
    wchar_t const* const*
        aFilterPatterns, /* NULL or wchar_t const * lFilterPatterns[1]={L"*.txt"} */
...
wchar_t* tinyfd_openFileDialogW(
    ...
    int aNumOfFilterPatterns, /* 0 (2 in the following example) */
    wchar_t const* const*
        aFilterPatterns, /* NULL or wchar_t const * lFilterPatterns[2]={L"*.png","*.jpg"} */
...
/* windows only - utf-16 version */
wchar_t* tinyfd_selectFolderDialogW(wchar_t const* aTitle, /* NULL or L"" */
