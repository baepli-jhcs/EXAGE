...
add_requires("assimp v5.2.5", "debugbreak", "entt v3.11.1", "fmt", "glfw 3.3.8", "glm", "magic_enum", "shaderc v2022.2", "stb 2023.01.30", "unordered_dense v3.0.0", "vulkan-headers 1.3.231+1")
...
target("EXAGE")
    ...
    add_packages("alpaca", "assimp", "cereal", "debugbreak", "entt", "fmt", "glfw", "glm", "imgui", "ktx", "magic_enum", "shaderc", "stb", "tl_expected", "unordered_dense", "vulkan-headers", "vma-hpp", {public = true})
